...
public interface FSMActivityIntegration {
     ...
     * it's current view.
     *
     * @param view     viewId to load
     * @param callback callback to init the view (optional)
     * @param states   state/s associated with this view
     */
    ...
    void onNewEvent(String eventName);

    void onNewEvent(String eventName, Object payload);
